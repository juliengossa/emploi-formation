...
```{r saphire, fig.cap="Activité des jeunes français.es entre 16 et 24 ans, depuis 1968, Source : base SAPHIR", out.width="60%", fig.align='center'}
...
```{r activite.34, out.width="75%",fig.align='center', fig.asp=9/16}
  plot_activite7() +
...
```{r dip2, out.width="75%",fig.align='center', fig.asp=9/16}
...
```{r activite.44, out.width="75%",fig.align='center', fig.asp=9/16}
  plot(plot_jeunes2)
```
