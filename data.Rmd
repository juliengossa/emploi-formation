...
La moyenne annuelle est donc réalisée à partir de 4 mois de l'année seulement, ce qui peut compremettre à la fiabilité des résultats si ces 4 mois ne sont pas assez représentatifs de l'ensmeble de l'année. 
```{r reformat}
