...
## 1. Réalisation d'un traitement de données des Enquêtes Emploi datant de 1971 à 2020
...
## 2. Aperçu de la répartition des jeunes de 15 à 29 ans selon le statut d'activité
...
## 3. Mise en lien des évolutions concernant le niveau de diplôme des jeunes avec celles des statuts d'activité selon l'année civile 
...
## 4. Vérification de l'effectif de jeunes au sein de nos données
...
## 5. Vérification sur les effectifs de jeunes chômeurs ou inactifs (hors étudiants) au sein de nos données
...
## 6. Analyse de la place des jeunes apprentis et de leur potentiel impact sur les NEET de 1976 à aujourd'hui
...
## 7. Impact du changement de définition de l'activité de 2003 sur le statut d'activité des individus entre 30 et 60 ans 
...
## 9. Visualisation plus fine de la transition formation-emploi à l'aide de tableaux croisés
...
## 11. Exploration des liens entre les différentes variables via la réalisation d'une Analyse en Composantes Principales
