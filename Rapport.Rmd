...
<!-- Il faudrait un abstract/résumé, de 5-10 lignes, du type : -->
<!-- Ce rapport présente une étude de la transition formation/emploi des jeunes en  -->
<!-- France depuis les années 1970. L'hypthèse que nous cherchons à vérifier est celle  -->
<!-- d'un rôle d'amortisseur de la formation entre la jeunesse et le chômage. Notamment, -->
<!-- nous cherchons à vérifier si le nombre de jeunes chômeurs et inactifs est relativement -->
<!-- constant. Pour ce faire, nous avons compilé les données de l'enquête emploi, que  -->
<!-- nous avons ensuite comparée aux données Eurostat et de recencensement. Notre  -->
<!-- conclusion est que ...  -->
...
### Pourcentages de population vs. effectifs absolus
...
<!-- Ajouter ici une pacture d'écran -->
