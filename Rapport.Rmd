...
## 1. Vue long terme (1971 - 2020) sur le statut d'activité des jeunes
...
## 2. Observations sur les évolutions concernant le niveau de diplôme des jeunes selon l'année civile (1971 - 2020)
...
## 3. Observations sur les évolutions des effectifs totaux de jeunes (15-29 ans) au fil des années.
...
## 4. Observations sur les effectifs de jeunes chômeurs ou inactifs (hors étudiants)
...
## 5. Observations sur les apprentis de 1976 à aujourd'hui
...
### 6.Comparaison données de l'Eurostat sur les jeunes avec nos données (emploi.RData)
...
## 7.Réalisation de tableaux croisés
...
## 8.Elaboration de l'application Shiny
...
## 9.Réalisation d'une Analyse en Composantes Principales
