...
Pour résumer, auparavant l'équation des moyens accordées aux universités était auparavant la suivante : $Budget = effectif \times dotation.par.étudiant$ alors qu'elle est maintenant : $Dotation.par.étudiant = \frac{Budget}{effectif}$.
